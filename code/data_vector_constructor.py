...
DESCRIPTOR_FORMAT_ANY_PUNC = '(?:[\n.,\/#!$&\*;:{}=\-_`~()\'\"])?'
DESCRIPTOR_FORMAT_SPACES = '\s+';
DESCRIPTOR_FORMAT_WORD = '\w+';

# matches any word before a match
DESCRIPTOR_FORMAT_BEFORE = DESCRIPTOR_FORMAT_ANY_PUNC + \
    DESCRIPTOR_FORMAT_WORD + DESCRIPTOR_FORMAT_ANY_PUNC + \
    DESCRIPTOR_FORMAT_SPACES;

# matches any word after a match
DESCRIPTOR_FORMAT_AFTER = DESCRIPTOR_FORMAT_ANY_PUNC + \
    DESCRIPTOR_FORMAT_SPACES + \
    DESCRIPTOR_FORMAT_ANY_PUNC + DESCRIPTOR_FORMAT_WORD + \
    DESCRIPTOR_FORMAT_ANY_PUNC;
